...
- C# with multi-targeted .NET (`net6.0`, `net7.0`, `net8.0`, `net9.0`, `net10.0`) + `Microsoft.Extensions.Hosting.Abstractions`, `Microsoft.Extensions.Http`, `Microsoft.Extensions.Logging`, `Microsoft.Extensions.Http.Polly` (001-wildcard-event-matching)
- N/A (in-memory routing/matching evaluation only) (001-wildcard-event-matching)
...
## Recent Changes
- 001-wildcard-event-matching: Added C# with multi-targeted .NET (`net6.0`, `net7.0`, `net8.0`, `net9.0`, `net10.0`) + `Microsoft.Extensions.Hosting.Abstractions`, `Microsoft.Extensions.Http`, `Microsoft.Extensions.Logging`, `Microsoft.Extensions.Http.Polly`
