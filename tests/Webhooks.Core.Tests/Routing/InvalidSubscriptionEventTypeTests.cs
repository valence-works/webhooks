...
public sealed class InvalidSubscriptionEventTypeTests
{
    [Fact]
    public async Task BroadcastAsync_LeadingWhitespaceSubscription_DoesNotMatch()
    {
    ...
    [Fact]
    public async Task BroadcastAsync_TrailingWhitespaceSubscription_DoesNotMatch()
    {
        var sinkProvider = new TestWebhookSinkProvider(new[]
        {
            new WebhookSink
    ...
    [Fact]
    public async Task BroadcastAsync_WhitespaceOnlySubscription_DoesNotMatch()
    {
        var sinkProvider = new TestWebhookSinkProvider(new[]
        {
            new WebhookSink
    ...
    [Fact]
    public async Task BroadcastAsync_LeadingWhitespaceWildcard_DoesNotMatch()
    {
        var sinkProvider = new TestWebhookSinkProvider(new[]
        {
            new WebhookSink
    ...
    [Fact]
    public async Task BroadcastAsync_TrailingWhitespaceWildcard_DoesNotMatch()
    {
        var sinkProvider = new TestWebhookSinkProvider(new[]
        {
            new WebhookSink
