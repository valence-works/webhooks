...
## Decision 2: Retry ownership is dispatcher-scoped per delivery attempt
- **Decision**: Retries run inside dispatcher implementation for each delivery attempt.
...
## Decision 3: Overflow behavior is host-configurable with fail-fast default
...
## Decision 5: Minimum observability contract per delivery attempt
...
## Decision 6: Payload predicate defaults
